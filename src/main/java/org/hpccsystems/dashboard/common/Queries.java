...
public class Queries {
    ...
    public static final String UPDATE_DASHBOARD =  "update dashboard_details set dashboard_name=?, composition = ?, column_count=?,source_id=?,last_updated_date=?,visibility=?,common_filter=? where dashboard_id=?";
